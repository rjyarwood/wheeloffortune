...
class Board:
    ...
    def __init__(self, root, question):
        ...
        self.solutionVar = ([StringVar(), StringVar(), StringVar(), StringVar(), StringVar(), StringVar(), StringVar(),
