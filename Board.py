...
def createBoard(root):
    ...
    board = Frame(root, bg=BOARDBACKGROUND)
    font = tk.Font(size=50)

    # Grid layout for board should be 12 14 14 12
    EMPTYLABEL = 'light sea green'

    # Row 1 Character Entries
    coord0_0 = Label(board, bg=EMPTYLABEL, bd=3, relief=SUNKEN, width=1, height=1, font=font)
...
def createPromptPanel(root):

    promptPanel = Frame(root)
